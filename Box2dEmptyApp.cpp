...
public:
    ...
    Pelota(b2World* _world, RenderWindow* _wnd)
    {
        ...
        /*b2FixtureDef fixPrueba;
        fixPrueba.shape = &dynamicBox;
        fixPrueba.density = 1.0f;
        fixPrueba.friction = 0.6f;
        fixPrueba.restitution = 1.0f;
        _body->CreateFixture(&fixPrueba);*/
    }
...
int _tmain(int argc, _TCHAR* argv[])
{
    ...
    Game* Juego;
    Juego = new Game(800, 600, "Esqueleto de Aplicación - MAVII.U2.E3");
