...
Game::Game(int ancho, int alto, std::string titulo)
{
    ...
    controlBody->ApplyLinearImpulse(impulso, origen, true);
...
void Game::DrawGame()
{
    ...
    sf::RectangleShape upShape(sf::Vector2f(500, 5));
    upShape.setFillColor(sf::Color::Red);
    upShape.setPosition(0, 95);
    wnd->draw(groundShape);
...
void Game::InitPhysics()
{
    ...
    b2Body* obstaculoUnoBody = Box2DHelper::CreateRectangularStaticBody(phyWorld, 5, 5);
    obstaculoUnoBody->SetTransform(b2Vec2(20.0f, 25.0f), 45.0f);

    b2Body* obstaculoDosBody = Box2DHelper::CreateRectangularStaticBody(phyWorld, 5, 5);
    obstaculoDosBody->SetTransform(b2Vec2(80.0f, 75.0f), 0.0f);

    b2Body* obstaculoTresBody = Box2DHelper::CreateCircularStaticBody(phyWorld, 3.0);
    obstaculoTresBody->SetTransform(b2Vec2(55.0f, 45.0f), 0.0f);

    b2Body* obstaculoCuatroBody = Box2DHelper::CreateTriangularStaticBody(phyWorld, b2Vec2(3.0f, 3.0f), 5.0f);
    obstaculoCuatroBody->SetTransform(b2Vec2(30.0f, 70.0f), 0.0f);
    ...
    controlBody = Box2DHelper::CreateCircularDynamicBody(phyWorld, 8, 1.0f, 0.5f, 0.1f);*/

    controlBody = Box2DHelper::CreateCircularDynamicBody(phyWorld, 5.0f, 1.0f, 0.0f, 1.0f);//CONSIGNA 1 //////////////////////////////
    controlBody->SetTransform(b2Vec2(80.0f, 25.0f), 0.0f);
